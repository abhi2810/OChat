...
import org.drulabs.Ochat.transfer.DataHandler;
...
import org.drulabs.Ochat.utils.DialogUtils;
import org.drulabs.Ochat.utils.Utility;
import org.drulabs.Ochat.wifidirect.WiFiDirectBroadcastReceiver;
...
//        connListener.start();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            ...
            LayoutInflater factory = LayoutInflater.from(LocalDashWiFiDirect.this);
            ...
            dialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface arg0, int arg1) {
                            Toast.makeText(LocalDashWiFiDirect.this,"Thanks",Toast.LENGTH_SHORT).show();
                        }
                    });
            dialog.setView(view);
            dialog.show();
